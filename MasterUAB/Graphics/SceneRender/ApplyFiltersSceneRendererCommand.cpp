...
CApplyFiltersSceneRendererCommand::CApplyFiltersSceneRendererCommand(tinyxml2::XMLElement* TreeNode, CLevel *_Level) : CStagedTexturedSceneRendererCommand(TreeNode,_Level)
{
