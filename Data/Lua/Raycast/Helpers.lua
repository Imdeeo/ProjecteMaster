function GetTriggerPos(_Target)
	return CUABEngine.get_instance():get_layer_manager():get_resource("triggers"):get_resource(_Target):get_position() - Vect3f(0.0, g_TotalHeight, 0.0)
end
