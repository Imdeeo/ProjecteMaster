...
function FnOnCreateController (_owner)
	...
	l_physXManager:create_character_controller("player", 1.0, 0.3, 0.5, _owner:get_position(),"controllerMaterial", 1)
end
...
function FnOnUpdateController (_owner, _ElapsedTime)
	...
	l_PosCharacterController.y = l_PosCharacterController.y - 0.3 - 0.5;
