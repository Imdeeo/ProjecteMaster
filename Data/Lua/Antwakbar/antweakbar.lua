...
function RegisterLineRendererParameters(line_renderer_name)
	...
	DebugHelper:add_variable("Pos Inicial X",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_inicial(0),"min=-100.0 max=100.0 step=0.1")
	DebugHelper:add_variable("Pos Inicial Y",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_inicial(1),"min=-100.0 max=100.0 step=0.1")
	DebugHelper:add_variable("Pos Inicial Z",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_inicial(2),"min=-100.0 max=100.0 step=0.1")
	DebugHelper:add_variable("Pos Final X",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_final(0),"min=-100.0 max=100.0 step=0.1")
	DebugHelper:add_variable("Pos Final Y",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_final(1),"min=-100.0 max=100.0 step=0.1")
	DebugHelper:add_variable("Pos Final Z",CDebugHelper.float,CDebugHelper.read_write,line_renderer:get_pos_final(2),"min=-100.0 max=100.0 step=0.1")
