...
function RegisterParticleParameters(particle_name)
	...
	DebugHelper:add_variable("Pos X",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_position(0),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Position\"")
	DebugHelper:add_variable("Pos Y",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_position(1),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Position\"")
	DebugHelper:add_variable("Pos Z",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_position(2),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Position\"")
	DebugHelper:add_variable("Size X",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_half_size(0),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Half Size\"")
	DebugHelper:add_variable("Size Y",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_half_size(1),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Half Size\"")
	DebugHelper:add_variable("Size Z",CDebugHelper.float,CDebugHelper.read_write,Particle:get_lua_emission_box_half_size(2),"min=-100.0 max=100.0 step=0.1 group=\"Emission Box Half Size\"")
